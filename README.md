...
You can optionally specify `MAX_TOKENS=` in your environment to restrict the maximum number of output tokens generated by the AI model. This configuration works uniformly across all supported providers (Cerebras, Groq, NVIDIA, and Ollama).
